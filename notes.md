...
- .md means markdown file - github renders them as formatted text

- untracked means git cans ee the file exists but is not tracking changes to it yet
    - new file you have never committed
